...
| 11, 12, 13, 14, 18, 20 | unidentified, and static through a full stop and start, so probably settings rather than state | 12 sits at 74031 and is not the Pump counter the panel shows |
