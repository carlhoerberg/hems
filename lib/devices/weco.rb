  ...
  class Weco
    ...
    def main_pack_response
      ...
      _crc1, _crc2 = @serial.read(2).unpack("CC")
      {
        ...
        SysVol: values[13] / 100.0,
        Current: values[14] / 100.0,
        MaxTmp: values[15] - 40,
        MinTmp: values[16] - 40,
        MaxVol: values[17] / 1000.0,
        MinVol: values[18] / 1000.0,
        SocValue: values[19] / 2.5,
        FactCap: values[20],
        VolValue_0: values[22] / 1000.0,
        VolValue_1: values[23] / 1000.0,
        VolValue_2: values[24] / 1000.0,
        VolValue_3: values[25] / 1000.0,
        VolValue_4: values[26] / 1000.0,
        VolValue_5: values[27] / 1000.0,
        VolValue_6: values[28] / 1000.0,
        VolValue_7: values[29] / 1000.0,
        VolValue_8: values[30] / 1000.0,
        VolValue_9: values[31] / 1000.0,
        VolValue_10: values[32] / 1000.0,
        VolValue_11: values[33] / 1000.0,
        VolValue_12: values[34] / 1000.0,
        VolValue_13: values[35] / 1000.0,
        VolValue_14: values[36] / 1000.0,
        VolValue_15: values[37] / 1000.0,
      }
    end
