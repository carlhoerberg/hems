...
class Devices
  class ETA
    ...
    def stallet_valve
      get("/user/var/124/10101/0/11125/2127")
    end
    ...
    def vvb_temp
      get "/user/var/125/10111/0/0/12271"
    end

    def vvb_should_temp
      get "/user/var/125/10111/0/0/12132"
    end

    def hotel_radiators_should_temp
      get "/user/var/125/10101/0/11125/2120"
    end
    
    def hotel_radiators_supply_temp
      get "/user/var/125/10101/0/11125/2121"
    end

    def hotel_radiators_valve
      get "/user/var/125/10101/0/11125/2127"
    end
