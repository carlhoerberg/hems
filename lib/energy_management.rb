...
class EnergyManagement
  ...
  def genset_support(soc = @devices.next3.battery.soc)
    if @devices.genset.is_running?
      ...
      elsif @devices.next3.battery.bms_recommended_charging_current.zero?
      ...
      p @devices.next3.battery.bms_recommended_discharging_current
      p @devices.next3.battery.bms_recommended_discharging_current > -300
      if soc <= 15
        start_genset
      end
    end
